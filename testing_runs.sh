...
python3 main.py --dataset_size=2500 --lsh_size=35 --nb_eLSHes=1150 --nb_matches_needed=14 --eps_t=90 --eps_f=50 --error_dist_file='amey_error_dist.json' --map='dict' --dataset='synth' --nb_queries=200 > synth2500.txt
#ls -al heap* >> rand10000_6_90.txt
#rm heap*

python3 main.py --dataset_size=5000 --lsh_size=37 --nb_eLSHes=1250 --nb_matches_needed=13 --eps_t=90 --eps_f=50 --error_dist_file='amey_error_dist.json' --map='dict' --dataset='synth' --nb_queries=200 > synth5000.txt
#ls -al heap* >> rand10000_6_90.txt
#rm heap*

python3 main.py --dataset_size=10000 --lsh_size=35 --nb_eLSHes=1500 --nb_matches_needed=19 --eps_t=90 --eps_f=50 --error_dist_file='amey_error_dist.json' --map='dict' --dataset='rand' --nb_queries=200 > rand10000.txt
#ls -al heap* >> rand10000_6_90.txt
#rm heap*
